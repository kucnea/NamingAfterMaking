...
<tiles:insertAttribute name="title"/>
	...
	function validId(){
		if(document.getElementById("pId").value.length > 0){
			location.href="/player/validupdateid?pId="+document.getElementById("pId").value+"&pNick="+document.getElementById("pNick").value+"&result2="+document.getElementById("result2").value;	
		}else{
			alert("입력된 아이디가 없습니다.");
		}
	...
	function validPNick(){
		if(document.getElementById("pNick").value.length > 0){
			location.href="/player/validupdatepnick?pId="+document.getElementById("pId").value+"&pNick="+document.getElementById("pNick").value+"&result1="+document.getElementById("result1").value;	
		}else{
                        ...
                        <div class="border-box">
                            ...
                            <form action="/player/create" method="post" id="joinForm">
                                <div class="form-field-wrapper">
                                    ...
                                    <c:choose>
                                    <c:when test="${pId1 eq null }">
                                    <input type="text" required="" placeholder="Enter your Id" name="pId" id="pId" class="input-sm form-full" aria-required="true" value="${player.getPId() }">
                                    </c:when>
                                    <c:otherwise>
