            ...
            <div class="container">
                <div class="row title">
                    ...
                    <div class="page-breadcrumb">
                        <a href="/index">Home</a>/<a href="/free/freelist">자유게시판</a>/<span>글쓰기</span>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="ptb-60 ptb-sm-30">
            <div class="container">
				...
				<div class="col-md-6 pb-60">
                        <!-- Contact FORM -->
                        <form action="/free/freesubmit" method="post" onsubmit="return submitValid()" enctype="multipart/form-data">
                            ...
                            <div class="form-field-wrapper">
                                <input class="input-sm form-full" id="freeTitle" type="text" name="freeTitle" placeholder="제목" required>
                            </div>
                            ...
                            <div class="form-field-wrapper">
                                <textarea class="form-full" id="freeContent" rows="7" name="freeContent" placeholder="내용" required></textarea>
                            </div>
